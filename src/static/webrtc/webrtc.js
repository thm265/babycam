...
var signalling_server_hostname = location.hostname || "mobile";
var signalling_server_address = signalling_server_hostname + ':' + (location.port || (location.protocol === 'https:' ? 443 : 8090));
...
function start() {
    if ("WebSocket" in window) {
        ...
        var server = signalling_server_address.toLowerCase();
